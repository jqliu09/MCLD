...
from src.DensePose.densepose.converters import ToChartResultConverterWithConfidences
from src.DensePose.densepose.structures import (
    DensePoseChartResultWithConfidences,
    DensePoseEmbeddingPredictorOutput,
)
from src.DensePose.densepose.vis.bounding_box import BoundingBoxVisualizer, ScoredBoundingBoxVisualizer
from src.DensePose.densepose.vis.densepose_outputs_vertex import DensePoseOutputsVertexVisualizer
from src.DensePose.densepose.vis.densepose_results import DensePoseResultsVisualizer
