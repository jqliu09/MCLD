...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def modify_from_pretrained(
        ...
        # modify the static dict, duplicate the feature part
        # aa = list(state_dict.keys())
        # bb = []
        # for a in aa:
        #     if 'attn2.' in a:
        #         bb.append(a)
        ...
        for key in state_dict:
            if 'attn2.' in key:
                new_state_dict[key.replace('attn2.', 'attn2_2.')] = state_dict[key]
