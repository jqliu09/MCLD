...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # here we define the convolution for handling the input convolution
        self.input_aux = input_aux
        self.input_conv = None
        if input_aux:
            self.input_conv = nn.Conv2d(input_aux + 4, 4, kernel_size=3, stride=1, padding=1)
    @property
