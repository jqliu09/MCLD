...
if __name__ == "__main__":
    ...
    cfg_path = "./configs/train/train.yaml"
    iter_num = 58242
    cur_pipeloader = MCLDPipelineLoader(cfg_path, num_tokens=16, image_proj_model=True)
    cur_pipeloader.init_model(model_path, iter_num, pipe_class=Pose2ImageIpMultiPipeline)
    ...
    test(cur_pipeloader, val_dataloader, infer_func=infer_func, save_dir=save_dir, exp_name=cfg.exp_name)